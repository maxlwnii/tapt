#!/bin/bash
#SBATCH --job-name=hpo_dnabert2_rnd
...
#SBATCH --mem=64G
#SBATCH --array=0-19
#SBATCH --output=logs/hpo_dnabert2_random_%A_%a.out
#SBATCH --error=logs/hpo_dnabert2_random_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=maximilian.lewinfr@gmail.com

# ============================================================
#  DNABERT2 Random Init — HPO across all RBPs × 2 datasets
#
#  Array: 0-19 = 10 RBPs × 2 datasets (csv, koo)
#  Submit: sbatch slurm_hpo_dnabert2_random.sh
# ============================================================
...
OUTPUT_DIR="$THESIS_ROOT/DNABERT2/finetune/hpo_results/dnabert2_random"

echo "========================================================"
echo "  DNABERT2 Random Init HPO"
echo "  RBP     : $RBP"
