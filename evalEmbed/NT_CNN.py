...
def onehot_to_seq(onehot_arr):
    ...
    idx = np.argmax(onehot_arr, axis=-1)
...
for layer in (32,10):
    ...
    for file in file_list:
        ...
        for i in range(5):
            ...
            os.makedirs('/home/fr/fr_fr/fr_ml642/Thesis/LLM_eval/chip-clip-seq/models', exist_ok=True)
            checkpoint = tf.keras.callbacks.ModelCheckpoint(
                                            f'/home/fr/fr_fr/fr_ml642/Thesis/LLM_eval/chip-clip-seq/models/{layer}_{tf_name}.h5',
                                            monitor='val_loss',
                                            save_best_only=True,
                                            mode = 'min',
                                            save_freq='epoch',)
    ...
    os.makedirs('/home/fr/fr_fr/fr_ml642/Thesis/LLM_eval/chip-clip-seq/results', exist_ok=True)
    df.to_csv(f'/home/fr/fr_fr/fr_ml642/Thesis/LLM_eval/chip-clip-seq/results/NT{layer}_perf.csv')
