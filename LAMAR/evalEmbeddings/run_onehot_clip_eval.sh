#!/bin/bash
#SBATCH --job-name=onehot_clip_eval
...
#SBATCH --mem=128G
#SBATCH --output=logs/onehot_clip_eval_%j.out
#SBATCH --error=logs/onehot_clip_eval_%j.err
...
# Run
echo "Starting OneHot CLIP Evaluation"
python OneHot_CNN_clip_data.py
