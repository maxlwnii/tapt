...
#SBATCH --mem=64G
#SBATCH --array=0-17
#SBATCH --output=logs/hpo_lamar_512_%A_%a.out
#SBATCH --error=logs/hpo_lamar_512_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=maximilian.lewinfr@gmail.com

# ============================================================
#  LAMAR_512 (tapt_lamar checkpoint-98000) — HPO
#
#  Array: 0-17 = 10 koo RBPs (0-9) + 8 csv RBPs (10-17)
#  Submit: sbatch slurm_hpo_lamar_512.sh
# ============================================================
...
# Pretrain weights: LAMAR_512 (tapt_lamar checkpoint-98000)
PRETRAIN_PATH="$LAMAR_DIR/src/pretrain/saving_model/tapt_lamar/checkpoint-98000/model.safetensors"
...
OUTPUT_DIR="$LAMAR_DIR/finetune_scripts/hpo_results/lamar_512"
